...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Baris bahasa berikut berisi pesan kesalahan baku yang digunakan oleh
    | kelas validator. Sebagian aturan memiliki beberapa versi seperti
    ...
    */
    ...
    'custom' => [
        'shipping_cost' => [
            'required' => 'Silakan pilih metode pengiriman terlebih dahulu.',
            'min' => 'Silakan pilih metode pengiriman terlebih dahulu.',
        ],
        'destinationId' => [
            'required' => 'Silakan pilih wilayah tujuan terlebih dahulu.',
        ],
        'courier' => [
            'required' => 'Silakan pilih kurir terlebih dahulu.',
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'destinationId' => 'Wilayah tujuan',
        'courier' => 'Kurir',
        'shipping_cost' => 'Metode pengiriman',
